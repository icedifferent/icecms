...
title('HTTP Content-type(Mime-Type)对照表');
?>
<style type="text/css">
.separateColor {background: #DFDFDF; color: ;}
</style>
<div class="title">HTTP Content-type(Mime-Type)对照表-<a href="index.php">HTML工具箱</a></div>
<table class="table" style="width:95%; text-align:left;" cellspacing="0" cellpadding="0"> 
	<tbody><tr>
       <th class="separateColor">扩展名</th>
       <th>Mime-Type</th>
       <th class="separateColor">扩展名</th>
       <th>Mime-Type</th>
     </tr>
		...
		<tr>
    		<td class="separateColor">.*(二进制流)</td>
